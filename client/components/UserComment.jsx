  ...
  export const UserComment = ({ quizID, quizComments, rateVal, setRate, commentVal, setComment, editVal, setEdit}) => {
    ...
    return (
        <div className={classes.root}>
            ...
            <h1>Review by Me<RateModal buttonText={"Edit"} quizID={quizID} rateVal={rateVal} commentVal={commentVal} setRate={setRate} setComment={setComment} editVal={editVal} setEdit={setEdit}/></h1>

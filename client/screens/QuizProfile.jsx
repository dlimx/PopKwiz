...
export const QuizProfile = () => {
    ...
    return (
        <div>
            <UserComment quizID={id} quizComments={quizComments} rateVal={rateVal} commentVal={commentVal} setRate={setRate} setComment={setComment} editVal={editVal} setEdit = {setEdit}/>
